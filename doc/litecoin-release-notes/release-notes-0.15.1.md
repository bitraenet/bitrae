Bitrae Core version *0.15.1* is now available from:

  <https://download.bitrae.net/bitrae-0.15.1/>
...
A number of changes to the way Bitrae Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 bites per kB (0.00001 BTRE). This is to prepare for dropping the minimum transaction fee to 0.1 bites per kB (0.0001 BTRE) in the next release.
