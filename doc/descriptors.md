# Support for Output Descriptors in Bitrae Core

Since Bitrae Core v0.17, there is support for Output Descriptors. This is a
...
existing Bitrae Core wallets, a convenience function `combo` is
