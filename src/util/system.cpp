...
const char * const BITCOIN_CONF_FILENAME = "bitrae.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitrae";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Bitrae";
#else
    // Unix-like
    return pathRet / ".bitrae";
#endif
#endif
}
