...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitrae-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitrae-tx [options] <hex-tx> [commands]  Update hex-encoded bitrae transaction\n" +
            "or:     bitrae-tx [options] -create [commands]   Create hex-encoded bitrae transaction\n" +
            "\n";
