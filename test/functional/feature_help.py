...
"""Verify that starting bitrae with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitrae with -h for help text")
        ...
        self.log.info("Start bitrae with -version for version information")
        ...
        self.log.info("Start bitraed with -fakearg to make sure it does not start")
