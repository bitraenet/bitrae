Contributing to Bitrae Core
============================

The Bitrae Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Bitrae Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/bitrae-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bitrae-qt
...
The following applies to code changes to the Bitrae Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitrae
Network Protocol consensus changes.

Whether a pull request is merged into Bitrae Core rests with the project merge
...
Patches that change Bitrae consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitrae consensus, it must have been
...
The project leader is the release manager for each Bitrae Core release.
